...
func (m *MockProductServiceInterface) Create(nome string, price float64) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", nome, price)
...
func (mr *MockProductServiceInterfaceMockRecorder) Create(nome, price interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockProductServiceInterface)(nil).Create), nome, price)
}
...
type MockProductPersistanceInterface struct {
	ctrl     *gomock.Controller
	recorder *MockProductPersistanceInterfaceMockRecorder
}
...
type MockProductPersistanceInterfaceMockRecorder struct {
	mock *MockProductPersistanceInterface
}
...
func NewMockProductPersistanceInterface(ctrl *gomock.Controller) *MockProductPersistanceInterface {
	mock := &MockProductPersistanceInterface{ctrl: ctrl}
	mock.recorder = &MockProductPersistanceInterfaceMockRecorder{mock}
	return mock
}
...
func (mr *MockProductPersistanceInterfaceMockRecorder) Get(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockProductPersistanceInterface)(nil).Get), id)
}
...
func (mr *MockProductPersistanceInterfaceMockRecorder) Save(product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockProductPersistanceInterface)(nil).Save), product)
}
